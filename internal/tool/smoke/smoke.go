...
func Checks() []Check {
	return []Check{
		...
		{Path: "/", Status: http.StatusOK, Contains: `<script type="module" async src="/assets/rill.client.`},
		{Path: "/", Status: http.StatusOK, Contains: "<!--rill:o0-->"},
		{Path: "/", Status: http.StatusOK, Contains: "<main", ContentType: "text/html"},
		{Path: "/", Status: http.StatusOK, Header: "Vary", HeaderValue: "RILL-Fragment, RILL-Partial"},
		{Path: "/", Status: http.StatusOK, Contains: `class="mark`},
		{Path: "/", Status: http.StatusOK, Contains: `<rill-island style="display:contents" name="Ticker"`},
		...
		{Path: "/", Status: http.StatusOK, Contains: `<rill-island style="display:contents" name="Stars" strategy="idle"`},
		{Path: "/", Status: http.StatusOK, Contains: `<rill-island style="display:contents" name="Response"`},
